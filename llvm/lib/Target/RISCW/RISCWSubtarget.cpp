...
RISCWSubtarget::RISCWSubtarget(const Triple &TT, StringRef CPU,
                               StringRef TuneCPU, StringRef FS,
                               StringRef ABIName,
                               const TargetMachine &TM)
    : RISCWGenSubtargetInfo(TT, CPU, TuneCPU, FS),

      TSInfo(), FrameLowering(initializeSubtargetDependencies(TT, CPU, TuneCPU,
                                                              FS, ABIName)),
      InstrInfo(*this), TLInfo(TM, *this), RegInfo(getHwMode()) {}
