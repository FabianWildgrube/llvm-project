...
static const MCPhysReg GPRArgRegs[] = {RISCW::X0, RISCW::X1, RISCW::X2,
                                       RISCW::X3};
...
bool RISCWTargetLowering::CanLowerReturn(
...
SDValue RISCWTargetLowering::LowerMemOpCallTo(SDValue Chain, SDValue Arg,
                                              const SDLoc &dl,
                                              SelectionDAG &DAG,
...
SDValue RISCWTargetLowering::LowerCallResult(
...
SDValue
RISCWTargetLowering::LowerReturn(SDValue Chain, CallingConv::ID CallConv,
                                 bool isVarArg,
...
SDValue RISCWTargetLowering::LowerGlobalAddress(SDValue Op,
                                                SelectionDAG &DAG) const {
  llvm_unreachable("Unsupported global address");
}

SDValue RISCWTargetLowering::LowerConstantPool(SDValue Op,
                                               SelectionDAG &DAG) const {
  llvm_unreachable("Unsupported constant pool");
}

SDValue RISCWTargetLowering::LowerBlockAddress(SDValue Op,
                                               SelectionDAG &DAG) const {
  llvm_unreachable("Unsupported block address");
}

SDValue RISCWTargetLowering::LowerRETURNADDR(SDValue Op,
                                             SelectionDAG &DAG) const {
  return SDValue();
}

SDValue RISCWTargetLowering::LowerOperation(SDValue Op,
                                            SelectionDAG &DAG) const {
  switch (Op.getOpcode()) {
