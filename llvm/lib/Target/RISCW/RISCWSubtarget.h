...
public:
  ...
  RISCWSubtarget(const Triple &TT, StringRef CPU, StringRef TuneCPU,
  ...
  const RISCWInstrInfo *getInstrInfo() const override { return &InstrInfo; }

  const TargetFrameLowering *getFrameLowering() const override {
    return &FrameLowering;
  }

  const RISCWRegisterInfo *getRegisterInfo() const override { return &RegInfo; }
